...
import { p as pg } from '../../chunks/index_Bxo-jn7C.mjs';
...
const POST = async ({ request, locals }) => {
  ...
  const SECRET_KEY = runtimeEnv.INSTAGRAM_UPDATE_SECRET || globalEnv.INSTAGRAM_UPDATE_SECRET || undefined                                       ;
  const DATABASE_URL = runtimeEnv.DATABASE_URL || globalEnv.DATABASE_URL || "postgresql://postgres:IIOLnmYvrhhsjNutQVnZGloKyCKYOkgm@caboose.proxy.rlwy.net:13340/railway";
